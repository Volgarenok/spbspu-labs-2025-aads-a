...
void parseAndExecute(BookSystem& system, const std::string& commandLine)
{
  ...
  {
    std::string bookName, key, record;
    iss >> bookName >> key;
  ...
  {
    std::string bookName, key, newRecord;
    iss >> bookName >> key;
  ...
  {
    std::string bookName, oldColor, newColor;
