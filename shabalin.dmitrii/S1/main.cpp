...
using listOfPairs = shabalin::List< std::pair< std::string, shabalin::List< size_t > > >;
...
template < typename T >
void outputList(std::ostream & out, shabalin::List< T > list)
{
  out << list.front();
