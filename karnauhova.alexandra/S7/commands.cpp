...
namespace
{
  void bound(std::ostream& out, std::istream& in, const karnauhova::Graphs& graphs, const std::string& b)
  {
    std::string graph;
    std::string vertex;
    in >> graph >> vertex;
    ...
    karnauhova::Graph::MapHash bound;
    if (b == "out")
    {
  ...
  void addEdges(karnauhova::Graph& newGraph, const karnauhova::Graph::Edge& edges)
  {
...
void karnauhova::input(std::istream& in, Graphs& graphs)
{
  std::string graph;
  while (in >> graph)
  {
...
void karnauhova::graphs(std::ostream& out, const Graphs& graphs)
{
  if (graphs.empty())
  {
    out << "\n";
...
void karnauhova::vertexes(std::ostream& out, std::istream& in, const Graphs& graphs)
{
  std::string graph;
  in >> graph;
...
void karnauhova::outBound(std::ostream& out, std::istream& in, const Graphs& graphs)
{
  bound(out, in, graphs, "out");
}

void karnauhova::inBound(std::ostream& out, std::istream& in, const Graphs& graphs)
{
  bound(out, in, graphs, "in");
}

void karnauhova::bind(std::istream& in, Graphs& graphs)
{
  std::string graph;
  std::string v1;
  std::string v2;
...
void karnauhova::cut(std::istream& in, Graphs& graphs)
{
  std::string graph;
  std::string v1;
  std::string v2;
...
void karnauhova::create(std::istream& in, Graphs& graphs)
{
  std::string graph;
  in >> graph;
...
void karnauhova::merge(std::istream& in, Graphs& graphs)
{
  std::string newGraph;
  std::string gr1;
  std::string gr2;
...
void karnauhova::extract(std::istream& in, Graphs& graphs)
{
  std::string newGraph;
  std::string graph;
  size_t count;
